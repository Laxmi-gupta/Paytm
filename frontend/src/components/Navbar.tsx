  ...
  return (
    <nav className="w-full border border-gray-300/40 bg-white">
      <div className="max-w-6xl mx-auto h-18 px-6 flex items-center justify-between">
        <Link to={'/dashboard'}><div className="flex items-center"><h2 className="text-3xl font-bold text-blue-900">Pay</h2><h2 className="text-3xl font-bold text-blue-400">X</h2></div></Link>
